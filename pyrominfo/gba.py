...
class GBAParser(RomInfoParser):
    ...
    * http://vbam.svn.sourceforge.net/viewvc/vbam/trunk/src/win32/RomInfo.cpp?view=markup
    ...
    def parse(self, filename):
        props = {}
        try:
            data = open(filename, "rb").read(0xc0)
    ...
    def isValidData(self, data):
        ...
        if len(data) >= 0xc0:
            ...
            return [ord(b) for b in data[0x04 : 0x04 + len(nintendo_logo)]] == nintendo_logo
